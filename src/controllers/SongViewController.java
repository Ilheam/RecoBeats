...
import models.Song;
import services.SongAdminService;
...
public class SongViewController implements Initializable {
	...
	@FXML
	private TableColumn<Song, Integer> colDuration;
	@FXML
	private TableColumn<Song, Void> deleteColumn;
	@FXML
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		SongAdminService service = new SongAdminService();
	...
	private void deleteSong(Song song) {
		...
		if (showConfirmationAlert("Confirmation de Suppression",
