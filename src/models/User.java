...
public class User {
	...
	public User(int userId, String firstName, String lastName, String userName, String password,
			LocalDateTime createdAt, List<String> preferences, List<String> playlist, List<String> favorites,
			List<String> history) {
	...
	public String toString() {
		return "User{" + "userId=" + getUserId() + ", firstName='" + getFirstName() + '\'' + ", lastName='"
