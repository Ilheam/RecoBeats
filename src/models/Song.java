...
public class Song {
	...
	public Song(int track_id) {
		this.track_id = track_id;
		// Initialiser les autres attributs à des valeurs par défaut
		this.track_name = "Unknown";
		this.artist_name = "Unknown";
		this.preview_url = "";
		this.tags = "";
		this.genre = Genre.OTHER; // ou une valeur par défaut appropriée
		this.year = 0;
		this.duration_ms = 0;
		this.danceability = 0;
		this.energy = 0;
