...
public class Preference {
	...
	public Preference(int userId, String genre, int preferredYear, String durationPref, float energy,
			float danceability, float acousticness, float instrumentalness, float valence, float speechiness) {
		this.userId = userId;
		this.genre = genre;
